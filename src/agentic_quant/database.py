...
event_alpha_cards = Table(
    "event_alpha_cards",
    metadata,
    Column("event_card_id", String(36), primary_key=True),
    Column(
        "catalyst_id",
        String(36),
        ForeignKey("catalysts.catalyst_id"),
        nullable=False,
        index=True,
    ),
    Column("symbol", String(24), nullable=False, index=True),
    Column("event_time", DateTime(timezone=True), nullable=False, index=True),
    Column("available_from", DateTime(timezone=True), nullable=False, index=True),
    Column("availability_basis", String(40), nullable=False),
    Column("as_of", DateTime(timezone=True), nullable=False, index=True),
    ...
    Column("status", String(24), nullable=False, index=True),
    Column("event_type", String(48), nullable=True, index=True),
    Column("direction", String(24), nullable=True, index=True),
    Column("mechanism", String(120), nullable=True),
    Column("novelty_score", Numeric(8, 6), nullable=True),
    Column("surprise_score", Numeric(8, 6), nullable=True),
    Column("source_quality_score", Numeric(8, 6), nullable=True),
    Column("confidence", Numeric(8, 6), nullable=True),
    Column("generalized_tags_json", JSON, nullable=False),
    Column("expected_horizons_json", JSON, nullable=False),
    Column("evidence_json", JSON, nullable=False),
    Column("card_json", JSON, nullable=True),
    Column(
        "llm_invocation_id",
        String(36),
...
event_alpha_outcomes = Table(
    "event_alpha_outcomes",
    metadata,
    Column("event_outcome_id", String(36), primary_key=True),
    Column(
        "event_card_id",
        String(36),
        ForeignKey("event_alpha_cards.event_card_id", ondelete="CASCADE"),
        nullable=False,
        index=True,
    ),
    Column("horizon_sessions", Integer, nullable=False, index=True),
    Column("entry_time", DateTime(timezone=True), nullable=False),
    Column("exit_time", DateTime(timezone=True), nullable=False),
    Column("available_from", DateTime(timezone=True), nullable=False, index=True),
    Column("entry_price", Numeric(20, 8), nullable=False),
    Column("exit_price", Numeric(20, 8), nullable=False),
    Column("total_return", Numeric(24, 12), nullable=False),
    Column("maximum_favorable_return", Numeric(24, 12), nullable=False),
    Column("maximum_adverse_return", Numeric(24, 12), nullable=False),
...
event_alpha_assessments = Table(
    "event_alpha_assessments",
    metadata,
    Column("event_assessment_id", String(36), primary_key=True),
    Column(
        "event_card_id",
        String(36),
    ...
    Column("selected_horizon_sessions", Integer, nullable=True, index=True),
    Column("analog_card_ids_json", JSON, nullable=False),
    Column("analog_statistics_json", JSON, nullable=False),
    Column("assessment_json", JSON, nullable=True),
...
event_alpha_playbooks = Table(
    "event_alpha_playbooks",
    metadata,
    Column("event_playbook_id", String(36), primary_key=True),
    Column(
        "event_assessment_id",
        String(36),
        ForeignKey("event_alpha_assessments.event_assessment_id"),
        nullable=False,
        unique=True,
    ),
    Column("name", String(160), nullable=False),
    Column("version", String(160), nullable=False, unique=True),
    Column("event_type", String(48), nullable=False, index=True),
    Column("direction", String(24), nullable=False),
    Column("holding_period_sessions", Integer, nullable=False, index=True),
    Column("status", String(32), nullable=False, index=True),
    Column("playbook_json", JSON, nullable=False),
    Column("gate_assessment_json", JSON, nullable=False),
    Column("code_sha256", String(64), nullable=False),
    Column("created_at", DateTime(timezone=True), nullable=False, index=True),
)
