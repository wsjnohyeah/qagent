...
- Local lint, strict type checking, 13 tests, API readiness, the HTTP vertical slice, and the secret scan pass.
...
2. Add market-session-aware gap detection, REST backfill, and durable reconnect supervision.
